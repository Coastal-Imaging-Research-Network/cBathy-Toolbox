function [f, G, bathy] = prepBathyInputShort( xyz, epoch, data, bathy )
...
%
%  Note that the Fourier coefficients, G, are normalized if the record is
%  long enough to do coherences (fPerBand >= params.shortLengthNFreqs).
%
